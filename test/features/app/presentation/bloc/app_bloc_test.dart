...
import 'package:portfolio/features/app/presentation/bloc/app_event.dart';
...
void main() {
  ...
  setUp(() {
    ...
    when(() => appLocalizationService.currentLocalization)
  ...
  group('AppBloc', () {
    ...
    blocTest<AppBloc, AppState>(
      ...
      setUp: () {
        when(() => appLocalizationService.changeLocale(any()))
            .thenAnswer((_) async {});
      },
      build: () => AppBloc(
        appTheme: appThemeService,
      ...
      verify: (_) {
        verify(() => appLocalizationService.changeLocale(const Locale('bg')))
            .called(1);
      },
    );
    ...
    blocTest<AppBloc, AppState>(
      ...
      verify: (_) {
        verify(() => appLayoutService.toggleMobile(isMobileLayoutEnabled: true))
            .called(1);
      },
    );
  });
